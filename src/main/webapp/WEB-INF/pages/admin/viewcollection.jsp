...
<div class="container">
    ...
    <c:if test="${empty artifactList}">
        <div class="alert alert-warning" role="alert">
            <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>Artifacat list is empty<a
                href="/artifact/add" type="button" class="btn btn-primary btn-sm">Upload</a>
        </div>
    </c:if>
            ...
            <c:forEach items="${artifactList}" var="artifact">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/artifact/delete/${artifact.id}" type="button"
                           class="btn btn-sm btn-warning">delete</a>
                        <a href="/artifact/update/${artifact.id}" type="button"
